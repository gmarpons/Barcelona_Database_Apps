...
barx <- barplot(c(results["enq1_edats_.15",1],results["enq1_edats_15_24",1],results["enq1_edats_25_39",1],results["enq1_edats_40_64",1],results["enq1_edats_.64",1],results["enq1_edats_NA",1]), names.arg=c("<15","15-24","25-39","40-64",">64","NS/NC"), main="Edat de la mostra\n(+ població)", sub="l'edat de tot el barri/districte)", xlab="edats (punts vermells per indicar", ylab="% de persones", cex.names=0.8)
...
barx <- barplot(c(results["enq1_edu_prim",1],results["enq1_edu_secu",1],results["enq1_edu_univ",1],results["enq1_edu_NA",1]), names.arg=c("Prim.","Secun.","Univ.","NS/NC"), main="Estudis de la mostra\n(+ població)", sub="estudis de tot el barri/districte)", xlab="estudis cursats (punts vermells pels", ylab="% de persones", cex.names=0.8)
...
## Opinions sobre la situació al seu barri
...
barx <- barplot(c(results["enq1_vivenda_prob_preu",1],results["enq1_vivenda_prob_oferta",1],results["enq1_vivenda_prob_oferta_pub",1],results["enq1_vivenda_prob_credit",1],results["enq1_vivenda_prob_condicions",1],results["enq1_vivenda_prob_desnona",1],results["enq1_vivenda_prob_buits",1]), main="Quin és el principal problema?", sub="per anàlisi conjunt de tots els barris de la ciutat)", xlab="índex de preocupació (punts verds", cex.names=0.8, horiz=T, las=1, xlim=c(0,30))
text(0.1,barx[,1]+0.25, c("Qualitat-preu","Manca d'oferta","Manca d'oferta pública","Accés al crèdit","Condicions dels habitatges","Desnonaments","Excés pisos buits"), pos=4)
