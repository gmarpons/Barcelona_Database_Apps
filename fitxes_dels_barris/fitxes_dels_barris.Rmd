...
------------- | ------------- | -------------
 |  |  
 Abstenció eleccions generals 2011 | `r round(100*sum(barris$abstencio_g11, na.rm = T)/sum(barris$electors_g11, na.rm = T),1)` | `r round(100*sum(ciutat$abstencio_g11, na.rm = T)/sum(ciutat$electors_g11, na.rm = T),1)`
 |  |  
