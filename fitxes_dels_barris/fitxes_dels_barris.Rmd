...
download.file("https://raw.githubusercontent.com/AnalisiGuanyem/Barcelona_Database/master/info_per_barris/info_per_barris_data.csv", 
              destfile="info_per_barris_data.csv")
...
Renda familiar bruta disponible[^2] | `r round(results["Renda_familiar_bruta_disponible",1],1)` | `r results["Renda_familiar_bruta_disponible",2]`
  |  |  
...
results[n_results,2] <- sum((barris$preulloguerm2_2011*barris$llars), na.rm = T)/sum(barris$llars, na.rm = T)
...
Densitat (habitants/hectàrea) | `r round(results["Densitat_habitants_hectarea",1],1)` | `r round(results["Densitat_habitants_hectarea",2],1)`
  |  |  
Llars amb titularitat (%) | `r round(results["Llars_amb_titularitat",1],1)` | `r round(results["Llars_amb_titularitat",2],1)`
...
[^3]: El percentatge de llars amb diferent tipus de tinença no sumen 100 perquè hi ha altres tipus (ex.: 'cedides') no recollits en aquesta taula.
...
------------- | ------------- | -------------
 |  |  
Població 2013 | `r round(results["Poblacio_2013",1],1)` | `r round(results["Poblacio_2013",2],1)`
...
[^5]: Els percentatges no sumen 100 exactament per diferències entre les fonts. Són estimacions aproximades.
