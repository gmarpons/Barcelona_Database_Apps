...
# Political data
# ---------------
rownames(results) <- c("Abstencio_eleccions_generals_2011")
results["Abstencio_eleccions_generals_2011",1] <- round(100*sum(barris$abstencio_g11, na.rm = T)/sum(barris$electors_g11, na.rm = T),1)
results["Abstencio_eleccions_generals_2011",2] <- round(100*sum(ciutat$abstencio_g11, na.rm = T)/sum(ciutat$electors_g11, na.rm = T),1)
n_results <- n_results + 1
results <- data.frame(rbind(results,c(NA,NA)))
rownames(results) <- c("Abstencio_eleccions_locals_2011")
results["Abstencio_eleccions_locals_2011",1] <- round(100*sum(barris$abstencio_g11, na.rm = T)/sum(barris$electors_g11, na.rm = T),1)
results["Abstencio_eleccions_locals_2011",2] <- round(100*sum(ciutat$abstencio_g11, na.rm = T)/sum(ciutat$electors_g11, na.rm = T),1)
n_results <- n_results + 1
results <- data.frame(rbind(results,c(NA,NA)))
```
...
------------- | ------------- | -------------
 ...
 |  |  
 Abstenció eleccions locals 2011 | `r round(100*(1-(sum(barris$votants_l11, na.rm = T)/sum(barris$electors_l11, na.rm = T))),1)` | `r round(100*(1-(sum(ciutat$votants_l11, na.rm = T)/sum(ciutat$electors_l11, na.rm = T))),1)`
 Vot a CIU eleccions locals 2011 | `r round(100*sum(barris$ciu_l11, na.rm = T)/sum(barris$votants_l11, na.rm = T),1)` | `r round(100*sum(ciutat$ciu_l11, na.rm = T)/sum(ciutat$votants_l11, na.rm = T),1)` 
 Vot a PSC eleccions locals 2011 | `r round(100*sum(barris$psc_l11, na.rm = T)/sum(barris$votants_l11, na.rm = T),1)` | `r round(100*sum(ciutat$psc_l11, na.rm = T)/sum(ciutat$votants_l11, na.rm = T),1)`
 Vot a PP eleccions locals 2011 | `r round(100*sum(barris$pp_l11, na.rm = T)/sum(barris$votants_l11, na.rm = T),1)` | `r round(100*sum(ciutat$pp_l11, na.rm = T)/sum(ciutat$votants_l11, na.rm = T),1)`
 Vot a ICV eleccions locals 2011 | `r round(100*sum(barris$icv_l11, na.rm = T)/sum(barris$votants_l11, na.rm = T),1)` | `r round(100*sum(ciutat$icv_l11, na.rm = T)/sum(ciutat$votants_l11, na.rm = T),1)`
 Vot a ERC eleccions locals 2011 | `r round(100*sum(barris$erc_l11, na.rm = T)/sum(barris$votants_l11, na.rm = T),1)` | `r round(100*sum(ciutat$erc_l11, na.rm = T)/sum(ciutat$votants_l11, na.rm = T),1)`
 |  |  
 Vot a CIU eleccions europees 2014 | `r round(100*sum(barris$ciu_eu14, na.rm = T)/sum(barris$votants_eu14, na.rm = T),1)` | `r round(100*sum(ciutat$ciu_eu14, na.rm = T)/sum(ciutat$votants_eu14, na.rm = T),1)` 
 Vot a PSC eleccions europees 2014 | `r round(100*sum(barris$psc_eu14, na.rm = T)/sum(barris$votants_eu14, na.rm = T),1)` | `r round(100*sum(ciutat$psc_eu14, na.rm = T)/sum(ciutat$votants_eu14, na.rm = T),1)`
 Vot a PP eleccions europees 2014 | `r round(100*sum(barris$pp_eu14, na.rm = T)/sum(barris$votants_eu14, na.rm = T),1)` | `r round(100*sum(ciutat$pp_eu14, na.rm = T)/sum(ciutat$votants_eu14, na.rm = T),1)`
 Vot a ICV eleccions europees 2014 | `r round(100*sum(barris$icv_eu14, na.rm = T)/sum(barris$votants_eu14, na.rm = T),1)` | `r round(100*sum(ciutat$icv_eu14, na.rm = T)/sum(ciutat$votants_eu14, na.rm = T),1)`
 Vot a ERC eleccions europees 2014 | `r round(100*sum(barris$erc_eu14, na.rm = T)/sum(barris$votants_eu14, na.rm = T),1)` | `r round(100*sum(ciutat$erc_eu14, na.rm = T)/sum(ciutat$votants_eu14, na.rm = T),1)`
 Vot a Podemos eleccions europees 2014 | `r round(100*sum(barris$pocem_eu14, na.rm = T)/sum(barris$votants_eu14, na.rm = T),1)` | `r round(100*sum(ciutat$pocem_eu14, na.rm = T)/sum(ciutat$votants_eu14, na.rm = T),1)`
  |  |  
...
------------- | ------------- | -------------
 |  |  
Atur (estimació)[^1] | `r round(100*(sum(barris$total_aturats, na.rm = T)*1.38)/(sum(barris$poblacio, na.rm = T)*0.51),1)` | `r round(100*(sum(ciutat$total_aturats, na.rm = T)*1.38)/(sum(ciutat$poblacio, na.rm = T)*0.51),1)`
Renda familiar bruta disponible[^2] | `r round(sum(barris$rfbc2012*barris$llars/sum(barris$llars, na.rm = T), na.rm = T),1)` | 100
  |  |  
